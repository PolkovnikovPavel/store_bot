...
def send_help(message):
	if message.text == '/help':
		bot.send_message(message.chat.id, 'По всем вопросам обращаться к @r6tuti, даже по самым тупым))')
	elif message.text == '/start':
		markup = create_markup([['Расценки', 'Правила', 'Информация'], ['/help', '/start']])
		bot.send_message(message.chat.id, 'Какой-то вступительный текст', reply_markup=markup)

		markup = create_markup([['Отзывы', 'https://t.me/joinchat/R9n7l7rBOx1jZjIy'],
							   ['Магазины', 'https://t.me/joinchat/R9n7l7rBOx1jZjIy']], 1)
		bot.send_message(message.chat.id, 'Ещё какой-то текст, чтоб объяснить ссылки ниже', reply_markup=markup)
